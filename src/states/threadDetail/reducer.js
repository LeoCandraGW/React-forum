...
function forumDetailReducer(forumDetail = null, action = {}) {
  switch (action.type) {
    ...
    case ActionType.ADD_FORUM_COMMENT:
      return {
        ...forumDetail, // Keep the existing state
          comments: [
            action.payload.comment, // Add the new comment
            ...forumDetail.comments // Preserve existing comments
          ]
      };
